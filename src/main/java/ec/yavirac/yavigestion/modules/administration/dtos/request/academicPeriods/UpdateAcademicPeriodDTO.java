...
@Getter
@Setter
@Schema(description = "Información necesaria para actualizar un período académico")
public class UpdateAcademicPeriodDTO {
    ...
    @Schema(
            ...
            example = "Actualización del período académico por cambio de fechas"
    )
    private String description;

    @Schema(
            description = "Estado actual del período académico",
            example = "ACTIVE"
    )
